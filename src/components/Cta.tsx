// Enhanced by AI on 2025-08-17T10:36:01.956Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    { value: "50K+", label: "Active Clients", icon: Users },
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  with Acme SAP Consulting
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the thousands of manufacturing leaders who have transformed their
                businesses with our proven SAP expertise. Start your journey today with
