// Enhanced by AI on 2025-08-17T10:36:01.639Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              New: Introducing AI-Powered SAP Features
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Unlock the power of SAP with our team of certified consultants. 
              We'll help you streamline operations, boost productivity, and drive business growth.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.9/5 Client Rating</span>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">SAP Implementation Demo</p>
                  </div>
                </div>
              </div>
